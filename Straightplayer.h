#ifndef STRAIGHTPLAYER_H
#define STRAIGHTPLAYER_H
...
class Straightplayer : public RandomPlayer{
...
void StraightvRandom();
};

int Straightplayer::getStraightMove(int straightRow, int straightCol){
    ...
    // If we are blocked we then head into the next column
        ...
        return straightRow, straightCol;
}
...
void Straightplayer::StraightvRandom(){
